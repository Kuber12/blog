    ...
    <div>
      ...
      <div className="d-flex flex-column justify-content-center align-items-center bg-light p-3">
        <div className="w-100 rounded bg-white border shadow p-4">
          <h1 style={{ textAlign: 'center', fontSize: '32px' }}>List of Blogs</h1>
                ...
                {data.map((d, i) => (
                  <tr key={i}>
                    ...
                    <td style={{ display: 'flex', flexWrap: 'wrap' }}>
                      ...
                      <Link to={`/EditBlog/${d._id}`} className="btn btn-sm btn-primary me-2">
                        Edit
                      </Link>
                      <button onClick={(e) => handleDelete(d._id)} className="btn btn-sm btn-danger">
                        Delete
                      </button>
                    </td>
                  </tr>
